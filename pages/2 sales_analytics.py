...
def load_page():
    try:
        ...
        if analysis_type == 'Profitability Analysis':
            ...
            df_hourly_profitability = get_hourly_profitability(
                query_date_filter)

            fig = px.line(df_hourly_profitability, x="HOURFORMATTED",
                          y="AVERAGEREVENUEPERHOUR", title="Average Revenue per Hour")
